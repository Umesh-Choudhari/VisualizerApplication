...
void SymmetricDDAandSutherLandCohen::drawLine()
{
    ...
    symmetricDDAObj.drawGrid(mVertices, mColors);
    symmetricDDAObj.drawLineBySymmetricDDA(line, mVertices, mPixelVertices);
...
void SymmetricDDAandSutherLandCohen::clipLine()
{
    ...
    Point3D pt1(xCoordinate, yCoordinate);
    Point3D pt2(x1Coordinate, x1Coordinate);

    Point3D pt3(xMin, yMin);
    Point3D pt4(xMax, yMax);

    Rectangle rectangle(pt3, pt4);
    ...
    SutherlandandCohenAlgorithm sutherlandCohen(line, diagonalLine, mVertices, mColors);
