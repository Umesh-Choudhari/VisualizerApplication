...
SymmetricDDAandSutherLandCohen::SymmetricDDAandSutherLandCohen(QWindow* parent) : QMainWindow(nullptr)
{
    setupUi();
    connect(mPushButton, &QPushButton::clicked, this, &SymmetricDDAandSutherLandCohen::clipLine);
    connect(mPushButton2, &QPushButton::clicked, this, &SymmetricDDAandSutherLandCohen::drawLine);
    connect(mPushButton3, &QPushButton::clicked, this, &SymmetricDDAandSutherLandCohen::drawCurveUsingHermite);
    connect(mPushButton4, &QPushButton::clicked, this, &SymmetricDDAandSutherLandCohen::drawCurveUsingBezier);
}

SymmetricDDAandSutherLandCohen::~SymmetricDDAandSutherLandCohen()
{

}
void SymmetricDDAandSutherLandCohen::drawCurveUsingBezier()
{
    mVertices.clear();
    mColors.clear();
    mColorss.clear();
...
void SymmetricDDAandSutherLandCohen::drawCurveUsingHermite()
{
    mVertices.clear();
    mColors.clear();
    mColorss.clear();
...
void SymmetricDDAandSutherLandCohen::drawLine()
{
    mVertices.clear();
    mColors.clear();
    mColorss.clear();
...
void SymmetricDDAandSutherLandCohen::clipLine()
{
    mVertices.clear();
    mColors.clear();
    mColorss.clear();
...
void SymmetricDDAandSutherLandCohen::setupUi() 
{
